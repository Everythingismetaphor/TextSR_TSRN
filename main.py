...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', default='srcnn', choices=['tsrn', 'bicubic', 'srcnn', 'vdsr', 'srres', 'esrgan', 'rdn',
                                                           'edsr', 'lapsrn'])
    parser.add_argument('--test', action='store_true', default=False)
    parser.add_argument('--statistics', action='store_true', default=False,help='TextZoom统计')
    parser.add_argument('--test_data_dir', type=str, default='../dataset/lmdb/str/TextZoom/test/hard/', help='测试数据的路径')
    parser.add_argument('--batch_size', type=int, default=None, help='')
    parser.add_argument('--resume', type=str, default=None, help='')
    parser.add_argument('--vis_dir', type=str, default=None, help='可视化图片保存的路径')
